...
import { showLoaderDelay } from "../renderer-common/renderer-helpers";
...
// import { useConfigStore } from '../common/config/config-pinia-store';

// import * as useConfigStore from '../common/config/config-pinia-store';


// import { storeToRefs } from 'pinia'
// import { useCounterStore } from '../common/config/config-pinia-store';
...
export default {
  ...
  setup(props) {
    ...
    // const store = useConfigStore.useConfigStore();
...
// const initialConfig = store.getConfig(deepCopy(defaultUserConfigOptions))


    // let test2 = deepCopy(defaultUserConfigOptions);
    // let test3 = defaultUserConfigOptions
    // // console.log(defaultUserConfigOptions)



    // // Define reactive properties
    ipcRenderer.send(IpcChannels.remoteLog, "🦄 (-98): ");
    ...
    onMounted(() => {
        ...
        dispatcher.on(VueEventChannels.mainWindowHasBeenHidden, () => {
            // const _config: UserConfigOptions = config.value;
            // if (!_config.generalOptions.persistentUserInput) {
            //     resetUserInput();
            // } else {
            //     selectUserInput();
            // }
        ...
        dispatcher.on(
            ...
            (updatedAppearanceOptions: AppearanceOptions) => {
                // const _config: UserConfigOptions = config.value;
                // _config.appearanceOptions = updatedAppearanceOptions;
            },
        );

        dispatcher.on(VueEventChannels.generalOptionsUpdated, (updatedGeneralOptions: GeneralOptions) => {
            // const _config: UserConfigOptions = config.value;
            // _config.generalOptions = updatedGeneralOptions;
        });
...
//     // Other setup or debugging tasks
