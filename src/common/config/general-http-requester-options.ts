...
export interface GeneralHttpRequesterOptions {
    isEnabled: boolean;
    generalHttpRequests: GeneralHttpRequest[];
}

export const defaultGeneralHttpRequesterOptions: GeneralHttpRequesterOptions = {
    isEnabled: true,
    generalHttpRequests: [
        {
