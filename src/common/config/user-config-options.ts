...
import { GeneralHttpRequesterOptions, defaultGeneralHttpRequesterOptions } from "./general-http-requester-options";
...
export interface UserConfigOptions {
    ...
    generalHttpRequesterOptions: GeneralHttpRequesterOptions;
}
...
export const defaultUserConfigOptions: UserConfigOptions = {
    ...
    generalHttpRequesterOptions: defaultGeneralHttpRequesterOptions,
};
